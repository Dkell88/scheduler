 ...
 const onDelete = () => {
  ...
  return (
    <article className="appointment">
      ...
      {mode === EDIT && (<Form onSave={save} onCancel={onCancel}  interviewers={props.interviewers} onChange={onChange} student={props.interview.student} interviewer={props.interview.interviewer.id}/>)}
